...
namespace Illuminate\Support\Facades {
     ...
     */        class Response {
         ...
         * 
         *
         * @see \App\Providers\ResponseMacroServiceProvider::responseApiSuccess()
         * @param mixed $response
         * @param int $status
         * @param array $headers
         * @param mixed $options
         * @static 
         */        public static function apiSuccess($response = [], $status = 200, $headers = [], $options = null)
        {
                        return \Illuminate\Routing\ResponseFactory::apiSuccess($response, $status, $headers, $options);
        }
                    /**
         * 
         *
         * @see \App\Providers\ResponseMacroServiceProvider::responseApiError()
         * @param mixed $response
         * @param int $status
         * @param array $headers
         * @param mixed $options
         * @static 
         */        public static function apiError($response = [], $status = 400, $headers = [], $options = null)
        {
                        return \Illuminate\Routing\ResponseFactory::apiError($response, $status, $headers, $options);
        }
            }
            /**
     * 
